...
<div class="breadcrumbs">
  <a href="<?=$index?>">Главная</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;<a href="<?=$accounting?>">Формирование учетов</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;<a href="<?=$ukr?>">Проверка граждан прибывших с Украины&nbsp</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;Всего прибыло лиц (УФМС, с начала текущего года)<?=$mode_type?>
</div>
...
while($row = mysql_fetch_assoc($stmt)):
  ...
  <tr>
    ...
    <?php else: ?>
      <td align="center"><a href="<?=$addr?>ukr/addressTotal.php?district=<?=$row['Район']?>&mode=<?=$mode?>"><?=$row['cnt']?></a></td>
    <?php endif; ?>
  </tr>
<?php endwhile; ?>
  <tr style="background: #F4F4F4;"><th>ВСЕГО</th><th><?=$cnt?></th></tr>
</table>
<?php
