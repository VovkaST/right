...
<table width="100%">
  <tr>
    <td width="40%" valign="top" style="padding: 10px 0;">
      <fieldset>
        <legend>Ввод связи с объектом "Электронный кошелек":</legend>
        <form method="POST" class="data_form">
          ...
          <table width="100%">
            ...
            <tr>
              <td align="right">№ кошелька:<span class="req">*</span></td>
              <td><input type="text" name="number" req="true"/></td>
            </tr>
            <tr height="25px">
    ...
    <td width="60%" valign="top" style="padding: 10px 0;">
      <fieldset class="related_objects">
        <?= related_wallets($_GET["id"], $_GET["object"]) ?>
      </fieldset>
    </td>
  </tr>
</table>