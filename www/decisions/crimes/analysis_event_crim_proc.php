...
<table rules="all" border="1" cellpadding="3" rules="all" class="result_table">
  ...
  <?php while ($result = mysql_fetch_assoc($query)): ?>
    <tr>
      ...
      <td align="center">
        <?php if($result['total']) : ?>
          <a href="events_list.php?ovd_id=<?= $result['id_ovd'] ?>&year=<?= $year ?>"><?= $result['total'] ?></a>
      ...
      <td align="center">
        <?php if($result['to_3']) : ?>
          <a href="events_list.php?ovd_id=<?= $result['id_ovd'] ?>&year=<?= $year ?>&differ=<4"><?= $result['to_3'] ?></a>
      ...
      <td align="center">
        <?php if($result['from_4_to_10']) : ?>
          <a href="events_list.php?ovd_id=<?= $result['id_ovd'] ?>&year=<?= $year ?>&differ=4,10"><?= $result['from_4_to_10'] ?></a>
      ...
      <td align="center">
        <?php if($result['from_11_to_30']) : ?>
          <a href="events_list.php?ovd_id=<?= $result['id_ovd'] ?>&year=<?= $year ?>&differ=11,30"><?= $result['from_11_to_30'] ?></a>
      ...
      <td align="center">
        <?php if($result['more_30']) : ?>
          <a href="events_list.php?ovd_id=<?= $result['id_ovd'] ?>&year=<?= $year ?>&differ=>30"><?= $result['more_30'] ?></a>
