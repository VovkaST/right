...
<table width="100%">
  <tr>
    <td width="40%" valign="top" style="padding: 10px 0;">
      <fieldset>
        <legend>Ввод связи с объектом "Банковская карта":</legend>
        <form method="POST" class="data_form">
          ...
          <table width="100%">
            ...
            <tr>
              ...
              <td colspan="3"><input type="text" name="number" class="account_num" req="true"/></td>
            </tr>
            <tr height="25px">
    ...
    <td width="60%" valign="top" style="padding: 10px 0;">
      <fieldset class="related_objects">
        <?= related_bank_cards($_GET["id"], $_GET["object"]) ?>
      </fieldset>
    </td>
  </tr>
</table>