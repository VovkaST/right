...
$query_1 = mysql_query('
  ...
  FROM
    (SELECT
      DISTINCT CASE
        WHEN r.`from_obj_type` = 8 THEN r.`from_obj`
        WHEN r.`to_obj_type` = 8 THEN r.`to_obj`
      END as `obj`
    FROM
      `l_relatives` as r
    WHERE
...
<center><span style="font-size: 1.2em;"><strong>Запросы по неустановленным банковским картам</strong></span></center>
