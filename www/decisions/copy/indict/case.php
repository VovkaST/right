...
try {
  ...
  $query = '
    SELECT SQL_NO_CACHE
      ...
      (SELECT MAX(`d04_f10`) FROM `ic_f1_f11` WHERE
         `d3n_f10` = f1ep.`d3n_f10` AND
         `d3g_f10` = f1ep.`d3g_f10` AND
         `d3o_f10` = f1ep.`d3o_f10` AND
         `d01_f10` = f1ep.`d01_f10` AND
         `d1p_f10` = f1ep.`d1p_f10`
         ) as `ep`,
      GROUP_CONCAT(
    ...
    FROM
      `ic_f1_f11` as f1
    JOIN
      `ic_f1_f11` as f1ep ON
        f1ep.`d3n_f10` = f1.`d3n_f10` AND
        f1ep.`d3g_f10` = f1.`d3g_f10` AND
        f1ep.`d3o_f10` = f1.`d3o_f10` AND
        f1ep.`d01_f10` = f1.`d01_f10` and 
        f1ep.`d1p_f10` = f1.`d1p_f10`
    WHERE
      f1.`id` = @cc
    GROUP BY
  ...
  $query = '
    ...
    JOIN
      `ic_f3_f4` as f3 ON
        (f3.`d3n_f3` = f1.`d3n_f10` AND
         YEAR(f3.`d06_f3`) = YEAR(f1.`d11_f10`) AND
         f3.`d01_f3` = f1.`d01_f10`)
        OR
        (f3.`d08n_f3` = f1.`d3n_f10` AND
         f3.`d08g_f3` = YEAR(f1.`d11_f10`) AND
         f3.`d01_f3` = f1.`d01_f10`)
    WHERE
  ...
  if (!empty($_t)) {
    ...
    $query = '
      ...
      LEFT JOIN
        `ic_f1_f11` as f1 ON
          f1.`d3n_f10` = f2.`d3n_f2` AND
          YEAR(f1.`d11_f10`) = YEAR(f2.`d031_f2`) AND
          f1.`d01_f10` = f2.`d01_f2`
      WHERE
        '.implode(' OR ', $str).'
    ';
  ...
  SELECT SQL_NO_CACHE
    DISTINCT
    IF(f3.`d08n_f3` = f1.`d3n_f10` AND f3.`d08g_f3` = YEAR(f1.`d11_f10`),
      (SELECT `id` FROM `ic_f1_f11` WHERE f3.`d3n_f3` = `d3n_f10` AND YEAR(f3.`d06_f3`) = YEAR(`d11_f10`) AND `d3o_f10` = 1 LIMIT 1),
      (SELECT `id` FROM `ic_f1_f11` WHERE f3.`d08n_f3` = `d3n_f10` AND f3.`d08g_f3` = YEAR(`d11_f10`) AND `d3o_f10` = 1 LIMIT 1)
    ) as `id`,
    IF(f3.`d08n_f3` = f1.`d3n_f10` AND f3.`d08g_f3` = YEAR(f1.`d11_f10`), f3.`d3n_f3`, f3.`d08n_f3`) as `number`,
    IF(f3.`d08n_f3` = f1.`d3n_f10` AND f3.`d08g_f3` = YEAR(f1.`d11_f10`), YEAR(f3.`d06_f3`), f3.`d08g_f3`) as `year`,
  ...
  if (!empty($_t)) {
   ...
   $query = '
      ...
      JOIN
        `ic_f1_f11` as f1 ON
          f5.`d03n_f5` = f1.`d3n_f10` AND 
          YEAR(f5.`d032_f5`) = YEAR(f1.`d11_f10`) AND
          f5.`d01_f5` = f1.`d01_f10`
      WHERE
        '.implode(' OR ', $str).'
