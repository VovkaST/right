...
<table width="100%">
  <tr>
    <td width="40%" valign="top" style="padding: 10px 0;">
      <fieldset>
        <legend>Ввод связи с объектом "Мобильное устр-во":</legend>
        <form method="POST" class="data_form">
          <input type="hidden" name="data_form" value="form_device"/>
          ...
          <table width="100%">
            ...
            <tr>
              <td align="right">№ IMEI:<span class="req">*</span></td>
              <td><input type="text" name="IMEI" class="IMEI" req="true"/></td>
            </tr>
            <tr height="25px">
    ...
    <td width="60%" valign="top" style="padding: 10px 0;">
      <fieldset class="related_objects">
        <?= related_mobile_devices($_GET["id"], $_GET["object"]) ?>
      </fieldset>
    </td>
  </tr>
</table>